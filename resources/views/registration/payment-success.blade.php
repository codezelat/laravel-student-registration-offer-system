<x-layout>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        @php
            $whatsappLinks = config('whatsapp.groups', []);
            $diplomaKey = 'Diploma in ' . $student->selected_diploma;
        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 md:p-10 border border-green-200/50 mb-6">
            <div class="text-center">
                <a href="{{ $whatsappLink }}" target="_blank" class="inline-flex items-center px-8 py-4 bg-green-600 hover:bg-green-700 text-white rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-105 active:scale-95">
